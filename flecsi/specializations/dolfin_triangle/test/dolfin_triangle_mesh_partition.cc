...
<<<<<<< HEAD:flecsi/mesh/test/dolfin_triangle/test/dolfin_triangle_mesh_partition.cc
...
>>>>>>> remotes/origin/execution:flecsi/specializations/dolfin_triangle/test/dolfin_triangle_mesh_partition.cc
