...
<<<<<<< HEAD:flecsi/mesh/test/dolfin_triangle/test/metis_partition_mesh_nodal.cc
    // get cell to vertices connectivity
    auto conn = dolfin.get_connectivity(0, 2, 0);
=======
    auto& conn = dolfin.get_connectivity(0, 2, 0);
>>>>>>> remotes/origin/execution:flecsi/specializations/dolfin_triangle/test/metis_partition_mesh_nodal.cc
